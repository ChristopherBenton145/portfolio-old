  ...
  return (
    <section className='projects'>
      ...
      <div className='container'>
        <Project title='Portfolio' description='This is my portfolio' live='https://christophers-portfolio42.netlify.app' code='https://github.com/ChristopherBenton145/portfolio-old' />
        <Project title='2048' description='This game is a type of “sliding block puzzle”' live='https://2048-42.netlify.app' code='https://github.com/ChristopherBenton145/2048' />
